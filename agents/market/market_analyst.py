...
BUYER TAXONOMY — AI Infrastructure:
...
BUYER TAXONOMY — Robotics & Industrial:
- TIER 1: Amazon Robotics, Tesla Manufacturing, BMW, Toyota — high-duty-cycle arm fleets
- TIER 2: Boston Dynamics, ABB, KUKA, Fanuc, Universal Robots — robot OEMs (reliability = brand)
- TIER 3: Siemens, Rockwell Automation, Honeywell — industrial automation systems
- TIER 4: Aerospace (Boeing, Airbus, SpaceX) — wiring harness reliability is safety-critical
- TIER 5: Maintenance/MRO companies — predictive failure = direct cost savings

BUYER TAXONOMY — Liquid Cooling / Data Center:
- TIER 1: AWS, Azure, GCP — direct opex from cooling failures = millions/hour downtime
- TIER 2: Vertiv, Schneider Electric, Stulz — cooling infrastructure OEMs
- TIER 3: LiquidStack, GRC, Asetek — immersion/liquid cooling specialists
- TIER 4: Supermicro, Dell, HPE — server OEMs adding liquid cooling

ROI CALCULATION — Semiconductor/AI:
1. GPU cost: H100 SXM5 ≈ $30,000-40,000
2. Revenue per GPU-hour (cloud): ~$2-4/hr
3. Thermal throttling 10%: $0.20-0.40/hr lost per GPU
4. 1,000 GPU cluster: ~$1.7M-3.5M/year in lost revenue
5. Solution value: up to 10% of that = $170K-350K/year/cluster

ROI CALCULATION — Robotics:
1. Industrial robot cost: $50K-200K per arm
2. Unplanned downtime: $5K-50K/hour (automotive line = ~$22K/min at Toyota)
3. Wiring harness failure = full arm replacement: $10K-30K parts + labor
4. Predictive detection → 1 avoided failure/year on 100-arm fleet: $1M-3M saved

ROI CALCULATION — Liquid Cooling:
1. Data center liquid cooling leak → emergency shutdown: $100K-$1M per incident
2. Pump cavitation → early replacement: $5K-20K pump + 8h labor
3. Galvanic corrosion → coolant contamination → full loop flush: $50K-200K
4. Prevention solution value: 20% of incident cost × incident rate
